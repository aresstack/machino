...
set -e
FILES="src/app/http/http_server.cpp src/app/http/setup.cpp src/app/rtsp/rtsp_server.cpp src/app/rtsp/rtsp_auth.cpp src/app/webrtc/peer.cpp src/app/main.cpp"
bad=0
